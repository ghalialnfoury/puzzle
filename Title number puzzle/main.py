...
class Game :
    ...
    def new(self) :
        ...
        self.start_game=False
        self.buttons_List= []
        self.buttons_List.append(Button(500,100,200,50,"Random",WHITE,BLACK))
    ...
    def update(self) :
        if self.start_game:
            ...
            if self.start_timer:
                ...
                self.start_timer =False
            self.elapsd_time=time.time() - self.timer
    ...
    def draw_grid(self):
        for row in range(-1,GAME_SIZE*TILESIZE,TILESIZE):
            pygame.draw.line(self.screen,   LIGHTGRAY, (row,0),    (row,GAME_SIZE*TILESIZE))
        for col in range(-1,GAME_SIZE*TILESIZE,TILESIZE):
            pygame.draw.line(self.screen,   LIGHTGRAY,  (0,col),    (GAME_SIZE*TILESIZE,col) )
    ...
    def draw(self):
        ...
        UIElement(550,35,"%.3f"% self.elapsd_time).draw(self.screen)
